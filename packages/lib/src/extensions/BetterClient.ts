...
export default class BetterClient extends Client {
	...
	/**
	 * This function is used when you want to slowly generate a hastebin. It provides a collection that can be accessed from the client, and will automatically append each string to a new line. You can use the {@link hasteFlush} function to upload the hastebin.
